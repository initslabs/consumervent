    ...
    <div>
        <div>
            ...
            <div class="header-content">
                ...
                <p>ConsumerVent helps amplify your positive reviews and complaints about a service, product or business</p>
            ...
            <div class="col-md-6 col-lg-offset-3">
                <div class="text-center">
                    ...
                    <p style="font-size: 16px;font-weight:100;" class="text-justify">
                        And the company does not need to have an account to handle complaints  - we provide a secure link for accessing submissions directly from the email notifications set out. Companies can see submissions, information on the customer as well as respond to them all from one single interface. Furthermore, ConsumerVent provides insights using graphical charts and displays into different trends relevant to the company
								<br />
								<br />
						<?php echo $this->Html->link('Demo Company Dashboard','/Dashboard',['class'=>'btn btn-success']) ; ?>  
